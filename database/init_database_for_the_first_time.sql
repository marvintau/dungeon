...
--- guard for newly created database
...
'{"hp": 2700, "id": "Scarlett", "class": "rouge", "range_type" : "near",
...
'{"hp": 3400, "id": "Hugh", "class": "hunter", "range_type" : "far",
...
('4955c25f-d40d-49b6-9bcd-9ffeebda0052',
 '{"hp": 2300, "id": "Merinda", "class": "mage", "range_type" : "far",
...
('9a9d925b-4ec4-41cd-a213-0038b8ec18b7',
 '{"hp": 3400, "id": "Wallace", "class": "warrior", "range_type" : "near",
...
create table char_chest(
    ...
    foreign key(char_id) references character_card_profile(id),
